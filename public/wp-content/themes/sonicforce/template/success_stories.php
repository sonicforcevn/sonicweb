		...
		<div class="the-solution">
			<div class="container">
				<div class="row">
						...
						<div class="sidebar-solution">
							<div class="widget widget-business">
								...
								<div class="list-business">
									<?php
										$terms = get_terms('business_type_stories',array('hide_empty' => false,'orderby' => 'ID','order' => 'DESC'));
										if($terms ) {
							...
							<div class="widget widget-industries">
								...
								<div class="list-industries">
									<?php
										$terms = get_terms('industries_stories',array('hide_empty' => false,'orderby' => 'ID','order' => 'DESC'));
										if($terms ) {
										foreach ( $terms as $term ) {
										$tid = $term->term_id;
									?>
							...
							<div class="widget widget-role">
								...
								<div class="list-role">
									<?php
										$terms = get_terms('role_stories',array('hide_empty' => false,'orderby' => 'ID','order' => 'DESC'));
										if($terms ) {
										foreach ( $terms as $term ) {
										$tid = $term->term_id;
									?>
				   ...
				   ?>
					<div class="col-12 col-md-9 solution-primary the-pagi" attr-cat="2">
